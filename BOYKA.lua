...
if tonumber(user_id) == tonumber(947425342) then  
var = true  
...
usertext = '\n ✪ العضو » ['..result.title_..'](t.me/'..(username or 'almoftaresss')..')'
status  = '\n ✪ تم ترقيته مطور'
...
usertext = '\n ✪ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'almoftaresss')..')'
status  = '\n ✪ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✪ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'almoftaresss')..') \n ✪ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ✪ العضو : {["..data.first_name_.."](T.ME/almoftaresss)}\n ✪ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✪ عذرا » {["..data.first_name_.."](T.ME/almoftaresss)}\n ✪ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
{{text = '♡ تيربو  ♡ ',url="t.me/ALMOFTARESs"}},
{{text = '♡قناه السورس♡',url="t.me/ALMOtfARESsM1"}},
}
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✪ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'almoftaresss')..') \n ✪ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✪ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'almoftaresss')..') \n ✪ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n ✪ اهلا بك في متجر ملفات المفترس\n ✪ ملفات السورس ↓\n◎ ══════ ❈ ══════ ◎\n\n"
local TextE = "\n◎ ══════ ❈ ══════ ◎\n ✪ علامة تعني { ✓ } ملف مفعل\n ✪ علامة تعني { ✘ } ملف معطل\n ✪ قناة 𝐒𝐎𝐔𝐑𝐂E𝚃𝙴𝚁𝙱𝙾 ↓\n".." ✪ [اضغط هنا لدخول](t.me/ROM1) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ✪ عذرا الملف لايدعم 𝐒𝐎𝐔𝐑𝐂𝐄 𝚃𝙴𝚁𝙱𝙾 \n") 
end
return false
end
...
local UserName = (b.username_ or "almoftaresss")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✪ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'almoftaresss')..')'
status  = '\n ✪ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✪ العضو » '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✪ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'almoftaresss')..')'..'\n ✪ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'المفترس').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'المفترس')
local BOYKA_Msg = {
'يوه '..Namebot..' زهق منك😒',
'نعم ياعيون '..Namebot..' 😻💓',
'عايز اي من '..Namebot..' 🙄💛',
...
if text == 'المفترس' or text == 'المفترس' or text == 'عبده' then
local Text = [[
✪┃المفترس يمكنك..💓
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝘼𝙇𝙈𝙊𝙁𝙏𝘼𝙍𝙀𝙎 ♥️🎌',url="t.me/ALMOFTARESs"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'almoftaresss')..')'
local iduser = result.sender_user_id_
...
local Text =[[
➫ ┇[𝐒𝐎𝐔𝐑𝐂𝐄  𝚃𝙴𝚁𝙱𝙾✪](t.me/almoftaresss
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝚃𝙴𝚁𝙱𝙾', url="t.me/ALMOtfARESs"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
الكيبورد الموجود في الأسفل
 ─────── ✪ ───────
 ➫ ┇[𝐒𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚁𝙱𝙾✪](t.me/almoftaresss)
[➫ ┇ المفترس♡](t.me/ALMOFTARESsh
)
 ─────── ✪ ───────
]]
keyboard = {} 
...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝚃𝙴𝚁𝙱𝙾 ', url="t.me/almoftaresss"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
✪┃تنظيف الكروبات
 ─────── ✪ ───────
 ➫ ┇[𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚁𝙱o ♡](t.me/almoftaresss)
➫ ┇[𝘼𝙇𝙈𝙊𝙁𝙏𝘼𝙍𝙀𝙎 🎌](t.me/ALMOFTARESs)
 ─────── ✪ ───────
]]
keyboard = {} 
...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝚃𝙴𝚁𝙱𝙾 ', url="t.me/almoftaresss"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
